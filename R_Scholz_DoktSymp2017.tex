...
\subtitle
{wie sie helfen die Geheimnisse heterogener Katalyse zu entschlüsseln} % (optional)
...
\begin{frame}{elektronische Reibung}
...
\begin{frame}{Wirkung von fs-Lasern auf Metalle}
...
%   
% \end{frame}
\begin{frame}{Wirkung hoher Elektronentemperatur auf Adsorbate}
...
%     \begin{figure}
      \hspace*{-.6cm}\includegraphics[width=1.1\textwidth]{figures/movie.png}
%     \end{figure}
% \vspace*{-.5cm}
      \begin{columns}[t]
  \column{.6\textwidth}
...
\begin{frame}{Danksagung}
  \begin{columns}[t]
    ...
    \column{0.3\textwidth}
      \begin{figure}
%         \includegraphics[width = .8 \textwidth]{saalfrank}
      \end{figure}
